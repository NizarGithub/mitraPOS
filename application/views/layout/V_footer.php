        ...
        <script type="text/javascript" src="<?php echo base_url();?>assets/custom_theme/js/moment.min.js"></script>
        ...
        <!-- Sweetalert -->
        <script src="<?php echo base_url();?>assets/custom_theme/plugin/sweetalert/sweetalert.min.js" type="text/javascript"></script>
        <!-- Numberformat -->
        <script src="<?php echo base_url();?>assets/custom_theme/plugin/numberformat/jquery.number.min.js" type="text/javascript"></script>
        <!-- END CUSTOM -->