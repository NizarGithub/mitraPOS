...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>assets/theme/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        ...
        <!-- Sweetalert -->
        <link href="<?php echo base_url()?>assets/custom_theme/plugin/sweetalert/sweetalert.css" rel="stylesheet">
        <!-- END CUSTOM -->
                                        ...
                                        <?php
                                            ...
                                            if ($mainmenu) {
                                              foreach ($mainmenu->result() as $row) {
                                                ...
                                                if (current_url() == base_url($row->menu_link) || current_url() == base_url($row->menu_alias)) {
                                                  $status = 'active';
                                                } else {
                                                  $status = '';
                                                }
                                                ...
                                                echo '
                                                <li class="menu-dropdown classic-menu-dropdown '.$status.'">
                                                    <a href="'.base_url($row->menu_link).'">
