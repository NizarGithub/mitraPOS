                                ...
                                <div class="portlet-body">
                                  ...
                                  <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Library/Pajak/postData/">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" name="pajak_nama" required />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control money" name="pajak_value" value="0" onchange="checkDiskonValue()" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <select class="form-control select2" id="pajak_outlet" name="pajak_outlet" aria-required="true" aria-describedby="select-error" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea class="form-control" rows="3" name="pajak_keterangan"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <select class="form-control select2" name="pajak_status_aktif" aria-required="true" aria-describedby="select-error" required>
        ...
        <script>
                ...
                $.ajax({
                  ...
                  success:function(data){
                    ...
                    for(var i=0; i<data.items.length;i++){
                        $('#pajak_outlet').append('<option id="outlet-'+data.items[i].id+'" value="'+data.items[i].id+'"> '+data.items[i].text+' </option>');
                    }
            ...
            function checkDiskonValue() {
                value = parseFloat(document.getElementsByName('pajak_value')[0].value.replace(/\,/g, ""));
                if (value > 100) {
                    document.getElementsByName('pajak_value')[0].value = 0;
                }
                $('.money').number( true, 2, '.', ',' );
            ...
            function showForm(id) {
                ...
                $.ajax({
                    type : "GET",
                    url  : '<?php echo base_url();?>Library/Pajak/loadDataWhere/',
                    data : "id="+id,
                    dataType : "json",
                    success:function(data){
                        for(var i=0; i<data.val.length;i++){
                            document.getElementsByName("kode")[0].value = data.val[i].kode;
                            document.getElementsByName("pajak_nama")[0].value = data.val[i].pajak_nama;
                            document.getElementsByName("pajak_value")[0].value = data.val[i].pajak_value;
                            if (document.getElementById('outlet-'+data.val[i].pajak_outlet)) {
                                document.getElementById('outlet-'+data.val[i].pajak_outlet).selected = true;    
                            }
                            $('#pajak_outlet').select2();
                            document.getElementsByName("pajak_keterangan")[0].value = data.val[i].pajak_keterangan;
                            if (data.val[i].pajak_status_aktif == 'y') {
                                document.getElementById('aktif').selected = true;
                            } else if (data.val[i].pajak_status_aktif == 'n') {
            ...
            function setNonaktif(id) {
              nonaktifData('Library/Pajak/nonaktifData', id);
            }

            function setAktif(id) {
              aktifData('Library/Pajak/aktifData', id);
            }
